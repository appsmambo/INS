...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-08-2015 a las 18:56:00
...
--
-- Estructura de tabla para la tabla `jembw_assets`
--

CREATE TABLE IF NOT EXISTS `jembw_assets` (
...
--
-- Volcado de datos para la tabla `jembw_assets`
--

INSERT INTO `jembw_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Estructura de tabla para la tabla `jembw_associations`
--

CREATE TABLE IF NOT EXISTS `jembw_associations` (
...
--
-- Estructura de tabla para la tabla `jembw_banners`
--

CREATE TABLE IF NOT EXISTS `jembw_banners` (
`id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `jembw_banner_clients`
--

CREATE TABLE IF NOT EXISTS `jembw_banner_clients` (
`id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `jembw_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `jembw_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `jembw_categories`
--

CREATE TABLE IF NOT EXISTS `jembw_categories` (
`id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `jembw_categories`
--

INSERT INTO `jembw_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Estructura de tabla para la tabla `jembw_contact_details`
--

CREATE TABLE IF NOT EXISTS `jembw_contact_details` (
`id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `jembw_content`
--

CREATE TABLE IF NOT EXISTS `jembw_content` (
...
--
-- Estructura de tabla para la tabla `jembw_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `jembw_contentitem_tag_map` (
...
--
-- Estructura de tabla para la tabla `jembw_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `jembw_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `jembw_content_rating`
--

CREATE TABLE IF NOT EXISTS `jembw_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `jembw_content_types`
--

CREATE TABLE IF NOT EXISTS `jembw_content_types` (
...
--
-- Volcado de datos para la tabla `jembw_content_types`
--

INSERT INTO `jembw_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Estructura de tabla para la tabla `jembw_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `jembw_core_log_searches` (
...
--
-- Estructura de tabla para la tabla `jembw_extensions`
--

CREATE TABLE IF NOT EXISTS `jembw_extensions` (
...
--
-- Volcado de datos para la tabla `jembw_extensions`
--

INSERT INTO `jembw_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2015 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"8bd6b13844c5699338145f26b30e0832"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Estructura de tabla para la tabla `jembw_finder_links`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links` (
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `jembw_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_taxonomy` (
`id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Volcado de datos para la tabla `jembw_finder_taxonomy`
--

INSERT INTO `jembw_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jembw_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `jembw_finder_terms`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_terms` (
`term_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `jembw_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `jembw_finder_terms_common`
--

INSERT INTO `jembw_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla `jembw_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `jembw_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `jembw_finder_types`
--

CREATE TABLE IF NOT EXISTS `jembw_finder_types` (
`id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `jembw_languages`
--

CREATE TABLE IF NOT EXISTS `jembw_languages` (
...
--
-- Volcado de datos para la tabla `jembw_languages`
--

INSERT INTO `jembw_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jembw_menu`
--

CREATE TABLE IF NOT EXISTS `jembw_menu` (
`id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `jembw_menu`
--

INSERT INTO `jembw_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Estructura de tabla para la tabla `jembw_menu_types`
--

CREATE TABLE IF NOT EXISTS `jembw_menu_types` (
`id` int(10) unsigned NOT NULL,
...
--
-- Volcado de datos para la tabla `jembw_menu_types`
--

INSERT INTO `jembw_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jembw_messages`
--

CREATE TABLE IF NOT EXISTS `jembw_messages` (
...
--
-- Estructura de tabla para la tabla `jembw_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `jembw_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `jembw_modules`
--

CREATE TABLE IF NOT EXISTS `jembw_modules` (
`id` int(11) NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Volcado de datos para la tabla `jembw_modules`
--

INSERT INTO `jembw_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Estructura de tabla para la tabla `jembw_modules_menu`
--

CREATE TABLE IF NOT EXISTS `jembw_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `jembw_modules_menu`
--

INSERT INTO `jembw_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `jembw_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `jembw_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
`id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `jembw_overrider`
--

CREATE TABLE IF NOT EXISTS `jembw_overrider` (
...
--
-- Estructura de tabla para la tabla `jembw_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `jembw_postinstall_messages` (
...
--
-- Volcado de datos para la tabla `jembw_postinstall_messages`
--

INSERT INTO `jembw_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `jembw_redirect_links`
--

CREATE TABLE IF NOT EXISTS `jembw_redirect_links` (
`id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `jembw_schemas`
--

CREATE TABLE IF NOT EXISTS `jembw_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `jembw_schemas`
--

INSERT INTO `jembw_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.4.0-2015-02-26');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jembw_session`
--

CREATE TABLE IF NOT EXISTS `jembw_session` (
...
--
-- Volcado de datos para la tabla `jembw_session`
--

INSERT INTO `jembw_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('8f1f0pq6nk3dv53guvb0ou65k3', 1, 1, '1439312113', '__default|a:8:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1439312113;s:18:"session.timer.last";i:1439312113;s:17:"session.timer.now";i:1439312113;s:22:"session.client.browser";s:109:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.130 Safari/537.36";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";N;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";N;s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"ea5e315b22a88e9ad71a725d61698078";}', 0, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jembw_tags`
--

CREATE TABLE IF NOT EXISTS `jembw_tags` (
`id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `jembw_tags`
--

INSERT INTO `jembw_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jembw_template_styles`
--

CREATE TABLE IF NOT EXISTS `jembw_template_styles` (
`id` int(10) unsigned NOT NULL,
...
--
-- Volcado de datos para la tabla `jembw_template_styles`
--

INSERT INTO `jembw_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.png","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(7, 'protostar', 0, '0', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}'),
(9, 'jumbotron', 0, '1', 'jumbotron - Predeterminado', '{"logotext":"Justified Nav Template","show_frontpage_component":"0","copyright":"Copyright 2014, All Rights Reserved","includejquery":"1"}'),
(10, 'jumbotron_narrow', 0, '0', 'jumbotron_narrow - Predeterminado', '{"logotext":"Jumbotron Narrow","show_frontpage_component":"0","copyright":"Copyright 2014, All Rights Reserved","includejquery":"1"}'),
(11, 'justifiednav', 0, '0', 'justifiednav - Predeterminado', '{"logotext":"Justified Nav Template","show_frontpage_component":"0","copyright":"Copyright 2014, All Rights Reserved","includejquery":"1"}');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jembw_ucm_base`
--

CREATE TABLE IF NOT EXISTS `jembw_ucm_base` (
...
--
-- Estructura de tabla para la tabla `jembw_ucm_content`
--

CREATE TABLE IF NOT EXISTS `jembw_ucm_content` (
...
--
-- Estructura de tabla para la tabla `jembw_ucm_history`
--

CREATE TABLE IF NOT EXISTS `jembw_ucm_history` (
...
--
-- Estructura de tabla para la tabla `jembw_updates`
--

CREATE TABLE IF NOT EXISTS `jembw_updates` (
...
--
-- Volcado de datos para la tabla `jembw_updates`
--

INSERT INTO `jembw_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
--
-- Estructura de tabla para la tabla `jembw_update_sites`
--

CREATE TABLE IF NOT EXISTS `jembw_update_sites` (
...
--
-- Volcado de datos para la tabla `jembw_update_sites`
--

INSERT INTO `jembw_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1439307101, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1439307099, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1439307099, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1439307099, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jembw_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `jembw_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';

--
-- Volcado de datos para la tabla `jembw_update_sites_extensions`
--

INSERT INTO `jembw_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(3, 10002),
...
--
-- Estructura de tabla para la tabla `jembw_usergroups`
--

CREATE TABLE IF NOT EXISTS `jembw_usergroups` (
`id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla `jembw_usergroups`
--

INSERT INTO `jembw_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla `jembw_users`
--

CREATE TABLE IF NOT EXISTS `jembw_users` (
`id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Volcado de datos para la tabla `jembw_users`
--

INSERT INTO `jembw_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(670, 'Super User', 'administrador', 'quintanilla.peru@gmail.com', '$2y$10$zcMgY8dHYT0dS5znffngWeKQvp5Gcy/COGpe2zwrDEresODRAHedS', 0, 1, '2015-08-11 15:29:05', '2015-08-11 16:55:12', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jembw_user_keys`
--

CREATE TABLE IF NOT EXISTS `jembw_user_keys` (
`id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `jembw_user_notes`
--

CREATE TABLE IF NOT EXISTS `jembw_user_notes` (
`id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `jembw_user_profiles`
--

CREATE TABLE IF NOT EXISTS `jembw_user_profiles` (
...
--
-- Estructura de tabla para la tabla `jembw_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `jembw_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `jembw_user_usergroup_map`
--

INSERT INTO `jembw_user_usergroup_map` (`user_id`, `group_id`) VALUES
(670, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jembw_viewlevels`
--

CREATE TABLE IF NOT EXISTS `jembw_viewlevels` (
`id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Volcado de datos para la tabla `jembw_viewlevels`
--

INSERT INTO `jembw_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indices de la tabla `jembw_assets`
--
ALTER TABLE `jembw_assets`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_asset_name` (`name`), ADD KEY `idx_lft_rgt` (`lft`,`rgt`), ADD KEY `idx_parent_id` (`parent_id`);

--
-- Indices de la tabla `jembw_associations`
--
ALTER TABLE `jembw_associations`
 ADD PRIMARY KEY (`context`,`id`), ADD KEY `idx_key` (`key`);

--
-- Indices de la tabla `jembw_banners`
--
ALTER TABLE `jembw_banners`
...
--
-- Indices de la tabla `jembw_banner_clients`
--
ALTER TABLE `jembw_banner_clients`
 ADD PRIMARY KEY (`id`), ADD KEY `idx_own_prefix` (`own_prefix`), ADD KEY `idx_metakey_prefix` (`metakey_prefix`);

--
-- Indices de la tabla `jembw_banner_tracks`
--
ALTER TABLE `jembw_banner_tracks`
...
--
-- Indices de la tabla `jembw_categories`
--
ALTER TABLE `jembw_categories`
...
--
-- Indices de la tabla `jembw_contact_details`
--
ALTER TABLE `jembw_contact_details`
...
--
-- Indices de la tabla `jembw_content`
--
ALTER TABLE `jembw_content`
...
--
-- Indices de la tabla `jembw_contentitem_tag_map`
--
ALTER TABLE `jembw_contentitem_tag_map`
...
--
-- Indices de la tabla `jembw_content_frontpage`
--
ALTER TABLE `jembw_content_frontpage`
 ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `jembw_content_rating`
--
ALTER TABLE `jembw_content_rating`
 ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `jembw_content_types`
--
ALTER TABLE `jembw_content_types`
 ADD PRIMARY KEY (`type_id`), ADD KEY `idx_alias` (`type_alias`);

--
-- Indices de la tabla `jembw_extensions`
--
ALTER TABLE `jembw_extensions`
...
--
-- Indices de la tabla `jembw_finder_filters`
--
ALTER TABLE `jembw_finder_filters`
 ADD PRIMARY KEY (`filter_id`);

--
-- Indices de la tabla `jembw_finder_links`
--
ALTER TABLE `jembw_finder_links`
...
--
-- Indices de la tabla `jembw_finder_links_terms0`
--
ALTER TABLE `jembw_finder_links_terms0`
...
--
-- Indices de la tabla `jembw_finder_links_terms1`
--
ALTER TABLE `jembw_finder_links_terms1`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_links_terms2`
--
ALTER TABLE `jembw_finder_links_terms2`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_links_terms3`
--
ALTER TABLE `jembw_finder_links_terms3`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_links_terms4`
--
ALTER TABLE `jembw_finder_links_terms4`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_links_terms5`
--
ALTER TABLE `jembw_finder_links_terms5`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_links_terms6`
--
ALTER TABLE `jembw_finder_links_terms6`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_links_terms7`
--
ALTER TABLE `jembw_finder_links_terms7`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_links_terms8`
--
ALTER TABLE `jembw_finder_links_terms8`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_links_terms9`
--
ALTER TABLE `jembw_finder_links_terms9`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_links_termsa`
--
ALTER TABLE `jembw_finder_links_termsa`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_links_termsb`
--
ALTER TABLE `jembw_finder_links_termsb`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_links_termsc`
--
ALTER TABLE `jembw_finder_links_termsc`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_links_termsd`
--
ALTER TABLE `jembw_finder_links_termsd`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_links_termse`
--
ALTER TABLE `jembw_finder_links_termse`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_links_termsf`
--
ALTER TABLE `jembw_finder_links_termsf`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `jembw_finder_taxonomy`
--
ALTER TABLE `jembw_finder_taxonomy`
...
--
-- Indices de la tabla `jembw_finder_taxonomy_map`
--
ALTER TABLE `jembw_finder_taxonomy_map`
 ADD PRIMARY KEY (`link_id`,`node_id`), ADD KEY `link_id` (`link_id`), ADD KEY `node_id` (`node_id`);

--
-- Indices de la tabla `jembw_finder_terms`
--
ALTER TABLE `jembw_finder_terms`
...
--
-- Indices de la tabla `jembw_finder_terms_common`
--
ALTER TABLE `jembw_finder_terms_common`
 ADD KEY `idx_word_lang` (`term`,`language`), ADD KEY `idx_lang` (`language`);

--
-- Indices de la tabla `jembw_finder_tokens`
--
ALTER TABLE `jembw_finder_tokens`
 ADD KEY `idx_word` (`term`), ADD KEY `idx_context` (`context`);

--
-- Indices de la tabla `jembw_finder_tokens_aggregate`
--
ALTER TABLE `jembw_finder_tokens_aggregate`
 ADD KEY `token` (`term`), ADD KEY `keyword_id` (`term_id`);

--
-- Indices de la tabla `jembw_finder_types`
--
ALTER TABLE `jembw_finder_types`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `title` (`title`);

--
-- Indices de la tabla `jembw_languages`
--
ALTER TABLE `jembw_languages`
...
--
-- Indices de la tabla `jembw_menu`
--
ALTER TABLE `jembw_menu`
...
--
-- Indices de la tabla `jembw_menu_types`
--
ALTER TABLE `jembw_menu_types`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indices de la tabla `jembw_messages`
--
ALTER TABLE `jembw_messages`
 ADD PRIMARY KEY (`message_id`), ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indices de la tabla `jembw_messages_cfg`
--
ALTER TABLE `jembw_messages_cfg`
 ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indices de la tabla `jembw_modules`
--
ALTER TABLE `jembw_modules`
 ADD PRIMARY KEY (`id`), ADD KEY `published` (`published`,`access`), ADD KEY `newsfeeds` (`module`,`published`), ADD KEY `idx_language` (`language`);

--
-- Indices de la tabla `jembw_modules_menu`
--
ALTER TABLE `jembw_modules_menu`
 ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indices de la tabla `jembw_newsfeeds`
--
ALTER TABLE `jembw_newsfeeds`
...
--
-- Indices de la tabla `jembw_overrider`
--
ALTER TABLE `jembw_overrider`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `jembw_postinstall_messages`
--
ALTER TABLE `jembw_postinstall_messages`
 ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indices de la tabla `jembw_redirect_links`
--
ALTER TABLE `jembw_redirect_links`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_link_old` (`old_url`), ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indices de la tabla `jembw_schemas`
--
ALTER TABLE `jembw_schemas`
 ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indices de la tabla `jembw_session`
--
ALTER TABLE `jembw_session`
 ADD PRIMARY KEY (`session_id`), ADD KEY `userid` (`userid`), ADD KEY `time` (`time`);

--
-- Indices de la tabla `jembw_tags`
--
ALTER TABLE `jembw_tags`
...
--
-- Indices de la tabla `jembw_template_styles`
--
ALTER TABLE `jembw_template_styles`
 ADD PRIMARY KEY (`id`), ADD KEY `idx_template` (`template`), ADD KEY `idx_home` (`home`);

--
-- Indices de la tabla `jembw_ucm_base`
--
ALTER TABLE `jembw_ucm_base`
...
--
-- Indices de la tabla `jembw_ucm_content`
--
ALTER TABLE `jembw_ucm_content`
...
--
-- Indices de la tabla `jembw_ucm_history`
--
ALTER TABLE `jembw_ucm_history`
 ADD PRIMARY KEY (`version_id`), ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`), ADD KEY `idx_save_date` (`save_date`);

--
-- Indices de la tabla `jembw_updates`
--
ALTER TABLE `jembw_updates`
 ADD PRIMARY KEY (`update_id`);

--
-- Indices de la tabla `jembw_update_sites`
--
ALTER TABLE `jembw_update_sites`
 ADD PRIMARY KEY (`update_site_id`);

--
-- Indices de la tabla `jembw_update_sites_extensions`
--
ALTER TABLE `jembw_update_sites_extensions`
 ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indices de la tabla `jembw_usergroups`
--
ALTER TABLE `jembw_usergroups`
...
--
-- Indices de la tabla `jembw_users`
--
ALTER TABLE `jembw_users`
 ADD PRIMARY KEY (`id`), ADD KEY `idx_name` (`name`), ADD KEY `idx_block` (`block`), ADD KEY `username` (`username`), ADD KEY `email` (`email`);

--
-- Indices de la tabla `jembw_user_keys`
--
ALTER TABLE `jembw_user_keys`
...
--
-- Indices de la tabla `jembw_user_notes`
--
ALTER TABLE `jembw_user_notes`
 ADD PRIMARY KEY (`id`), ADD KEY `idx_user_id` (`user_id`), ADD KEY `idx_category_id` (`catid`);

--
-- Indices de la tabla `jembw_user_profiles`
--
ALTER TABLE `jembw_user_profiles`
 ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indices de la tabla `jembw_user_usergroup_map`
--
ALTER TABLE `jembw_user_usergroup_map`
 ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indices de la tabla `jembw_viewlevels`
--
ALTER TABLE `jembw_viewlevels`
...
--
-- AUTO_INCREMENT de la tabla `jembw_assets`
--
ALTER TABLE `jembw_assets`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=54;
--
-- AUTO_INCREMENT de la tabla `jembw_banners`
--
ALTER TABLE `jembw_banners`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_banner_clients`
--
ALTER TABLE `jembw_banner_clients`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_categories`
--
ALTER TABLE `jembw_categories`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de la tabla `jembw_contact_details`
--
ALTER TABLE `jembw_contact_details`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_content`
--
ALTER TABLE `jembw_content`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_content_types`
--
ALTER TABLE `jembw_content_types`
MODIFY `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT de la tabla `jembw_extensions`
--
ALTER TABLE `jembw_extensions`
MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10006;
--
-- AUTO_INCREMENT de la tabla `jembw_finder_filters`
--
ALTER TABLE `jembw_finder_filters`
MODIFY `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_finder_links`
--
ALTER TABLE `jembw_finder_links`
MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_finder_taxonomy`
--
ALTER TABLE `jembw_finder_taxonomy`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `jembw_finder_terms`
--
ALTER TABLE `jembw_finder_terms`
MODIFY `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_finder_types`
--
ALTER TABLE `jembw_finder_types`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_languages`
--
ALTER TABLE `jembw_languages`
MODIFY `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `jembw_menu`
--
ALTER TABLE `jembw_menu`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=102;
--
-- AUTO_INCREMENT de la tabla `jembw_menu_types`
--
ALTER TABLE `jembw_menu_types`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `jembw_messages`
--
ALTER TABLE `jembw_messages`
MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_modules`
--
ALTER TABLE `jembw_modules`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=87;
--
-- AUTO_INCREMENT de la tabla `jembw_newsfeeds`
--
ALTER TABLE `jembw_newsfeeds`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_overrider`
--
ALTER TABLE `jembw_overrider`
MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT de la tabla `jembw_postinstall_messages`
--
ALTER TABLE `jembw_postinstall_messages`
MODIFY `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `jembw_redirect_links`
--
ALTER TABLE `jembw_redirect_links`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_tags`
--
ALTER TABLE `jembw_tags`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `jembw_template_styles`
--
ALTER TABLE `jembw_template_styles`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT de la tabla `jembw_ucm_content`
--
ALTER TABLE `jembw_ucm_content`
MODIFY `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_ucm_history`
--
ALTER TABLE `jembw_ucm_history`
MODIFY `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_updates`
--
ALTER TABLE `jembw_updates`
MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=61;
--
-- AUTO_INCREMENT de la tabla `jembw_update_sites`
--
ALTER TABLE `jembw_update_sites`
MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `jembw_usergroups`
--
ALTER TABLE `jembw_usergroups`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `jembw_users`
--
ALTER TABLE `jembw_users`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=671;
--
-- AUTO_INCREMENT de la tabla `jembw_user_keys`
--
ALTER TABLE `jembw_user_keys`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_user_notes`
--
ALTER TABLE `jembw_user_notes`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jembw_viewlevels`
--
ALTER TABLE `jembw_viewlevels`
